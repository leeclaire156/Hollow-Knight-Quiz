...
allChoices.forEach((choices, playerAns) => {
    choices.addEventListener("click", () => {
        ...
        } else {//if you ran out of questions, this else function takes you to the save score page

            //save score function here
            quizPage.style.display = "none";
            saveScorePage.style.display = "block";
            //should display score
            finalPlayerScore.innerText = playerScore;
            // clearInterval(timer);
            // secondsLeft = 5 * 60;
        ...
        console.log(choices);
        //should be correct or wrong checker
